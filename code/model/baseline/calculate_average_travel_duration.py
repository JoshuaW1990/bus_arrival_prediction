"""
Calculate the travel duration for the each segment pair according to the segment.csv file with different baseline algorithm requirements:
1. baseline1, not considering the weather and the rush hour
2. baseline2, only considering the weather and the rush hour
3. baseline3, considering the specific trip id and the time point.
"""
...
print len(segment_df)
# Define the rush hour
rush_duration = ('17:00:00', '20:00:00')
new_segment_df1 = obtain_segment_set_baseline1(segment_df)
new_segment_df2 = obtain_segment_set_baseline2(segment_df, rush_duration)
